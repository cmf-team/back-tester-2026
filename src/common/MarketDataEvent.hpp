...
struct MarketDataEvent {
  ...
  //                 std::uint64_t order_id_, price_t price_, std::uint32_t
  //                 size_, Side side_, Action action_, Flag flag_, std::uint8_t
  //                 rtype_, std::uint32_t source_file_id_)
  ...
  //       size(size_), side(side_), action(action_), flag(flag_),
  //       rtype(rtype_), source_file_id(source_file_id_) {}
  ...
  [[nodiscard]] static double priceToDouble(price_t price) noexcept {
